...
├── index.html
└── images/
    ├── main.jpeg     ← 커버 메인 사진 (세로 길쭉, 1080x1920 추천)
    ├── groom.jpeg    ← 신랑 프로필 (정사각형)
    ├── bride.jpeg    ← 신부 프로필 (정사각형)
    ├── g1.jpeg       ← 갤러리 1 (가로형, 큰 사이즈)
    ├── g2.jpeg       ← 갤러리 2 (정사각형)
    ├── g3.jpeg       ← 갤러리 3 (정사각형)
    ├── g4.jpeg       ← 갤러리 4 (정사각형)
    └── g5.jpeg       ← 갤러리 5 (정사각형)
...
**사진이 다 깨져요**
→ 파일명 대소문자/확장자(.jpeg vs .jpeg) 정확히 맞는지 확인. `images` 폴더 안에 있는지도.
